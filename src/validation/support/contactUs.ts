import { emailRegex, fullNameRegex, phoneRegex } from '@constants/contactUs'
...
export const contactUsValidationSchema = object({
  ...
  email: string()
    .email()
    .matches(emailRegex, i18next.t(Translation.PAGE_CONTACT_US_VALIDATION_EMAIL_MATCHES) as string)
