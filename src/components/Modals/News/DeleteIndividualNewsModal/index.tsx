...
export interface IDeleteIndividualNews {
  id: string
}

export const DeleteIndividualNewsModal = ({ id }: IDeleteIndividualNews) => {
  const [t] = useTranslation()

  const onClose = useCallback(() => {
    dispatch(viewsMiddleware.closeModal(ModalName.DeleteIndividualNewsModal))
  }, [])

  const onDelete = () => {
    dispatch(newsMiddleware.deleteIndividualNews(id))
