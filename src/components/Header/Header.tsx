...
export const Header = () => {
  ...
  return (
    <>
      <div className="absolute h-[120px] w-full">
        <div className="relative bottom-0 aspect-[1440/120] w-full bg-[url('/wave/wave-header.svg')] bg-cover bg-center bg-no-repeat" />
      </div>
      <div className="sticky top-0 z-40">
        <Disclosure as="nav">
          {({ open }) => (
            <>
              <Container>
                <div className="relative flex h-[111px] items-center justify-between">
