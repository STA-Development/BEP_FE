...
const AdditionalPositions = () => {
  ...
  const fieldName = 'additionalPositions'
  ...
  return (
    <div className="radius relative rounded bg-primary-light p-6">
      <p className="text-white">
        {t(Translation.PAGE_MONITORING_SYSTEM_FORM_ORGANIZATION_PLANS_ADDITIONAL_POSITIONS_SHORT)}
      </p>
...
export default AdditionalPositions
