...
const ButtonColor = ['primary', 'secondary'] as const
const ButtonSize = ['xs', 'sm', 'bs', 'lg', 'hg', 'app'] as const
      ...
      className={clsxMerge(
        ...
        [
          variant === 'contained' && [
            ...
            color === 'secondary' &&
              'border-secondary bg-secondary text-primary hover:text-secondary',
          ],
          variant === 'outlined' && [
            'hover:border-primary-light hover:bg-primary-light',
          ...
          variant === 'text' && 'border-transparent text-white hover:underline',
        ],
        [
          radius === 'all' && 'rounded',
          radius === 'r' && 'rounded-r',
