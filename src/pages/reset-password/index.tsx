              ...
              <input
                ...
                className={`${
                  error
                    ? 'border-red placeholder:text-red'
                    : 'border-gray-light placeholder:text-black'
                } w-full rounded border px-5 py-2.5 outline-none outline-none outline-0  placeholder:text-base`}
              ...
              <input
                ...
                className={`${
                  error
                    ? 'border-red placeholder:text-red'
                    : 'border-gray-light placeholder:text-black'
                } mb-5 w-full rounded border px-5 py-2.5 outline-0 placeholder:text-base`}
              />
              <input
                type="password"
                id="confirm_password"
