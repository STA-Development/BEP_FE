...
const SingleNews = ({ news }: { news: INewsProps }) => (
  <div
    key={news.id}
    className="my-10 mx-auto grid grid-cols-1 items-center justify-between rounded-lg border-2 border-solid border-gray-thin p-8 hover:border-primary xl:grid-cols-2"
  >
    <div className="order-last ml-4 mb-4 space-y-4 xl:order-first">
      ...
      <Button
        rightIcon={<RightIcon fill="fill-cyan-800" />}
